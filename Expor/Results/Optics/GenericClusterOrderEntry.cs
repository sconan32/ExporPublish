...
namespace Socona.Expor.Results.Optics
{
    ...
    public class GenericClusterOrderEntry : IComparable<IClusterOrderEntry>, IClusterOrderEntry
    {
        /**
         * The id of the entry.
         */
         ...
         */
        private IDistanceValue reachability;
         ...
         */
        public GenericClusterOrderEntry(IDbId objectID, IDbId predecessorID, IDistanceValue reachability)
        {
