...
namespace Socona.Clustering.Utilities.Parameter
{
    ...
    public class Parameter<T,S> where S :T
    {
   ...
   */
  protected readonly List<ParameterConstraint<S>> constraints;

  /**
   * The option name.
   */
  protected readonly ParameterDescription optionName;
   ...
   */
  public Parameter(ParameterDescription optionID, List<ParameterConstraint<S>> constraints, T defaultValue) {
    this.optionName = optionID;
    this.shortDescription = optionID.GetDescription();
    this.optionalParameter = true;
    this.defaultValue = defaultValue;
    this.constraints = (constraints != null) ? constraints : new List<ParameterConstraint<S>>();
  }
   ...
   */
  public Parameter(ParameterDescription optionID, List<ParameterConstraint<S>> constraints, bool optional) {
    this.optionName = optionID;
    this.shortDescription = optionID.GetDescription();
   ...
   *        are no constraints
   */
  public Parameter(ParameterDescription optionID, List<ParameterConstraint<S>> constraints):
   ...
   * @param defaultValue the default value of this parameter (may be null)
   */
  public Parameter(ParameterDescription optionID, ParameterConstraint<S> constraint, T defaultValue) :
   ...
   * @param optional specifies if this parameter is an optional parameter
   */
  public Parameter(ParameterDescription optionID, ParameterConstraint<S> constraint, bool optional) {
   ...
   * @param constraint the constraint of this parameter
   */
  public Parameter(ParameterDescription optionID, ParameterConstraint<S> constraint) {
   ...
   */
  public Parameter(ParameterDescription optionID, T defaultValue) {
   ...
   */
  public Parameter(ParameterDescription optionID, boolean optional) {
   ...
   * @param optionID the unique id of the option
   */
  public Parameter(ParameterDescription optionID) {
   ...
   */
  private static List<ParameterConstraint<S>> makeConstraintsVector(ParameterConstraint<S> constraint) {
   ...
   */
  public bool hasValuesDescription() {
    return false;
  }
   ...
   */
  protected bool validate(T obj) throws ParameterException {
    try {
   ...
   * @return Option ID
   */
  public ParameterDescription getOptionID() {
    return optionid;
  }
   ...
   * @param val Value
   */
  protected sealed void setValueInternal(T val) {
   ...
   *         option.
   */
  public sealed boolean isValid(Object obj) throws ParameterException {
    T val = parseValue(obj);
    return validate(val);
  }
