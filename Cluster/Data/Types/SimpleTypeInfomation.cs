...
using System.Linq;
using System.Text;
using Socona.Clustering.Persistent;
...
namespace Socona.Clustering.Data.Types
{
     ...
     */
    public class SimpleTypeInformation<T> : ITypeInformation
    {
        /**
        ...
        {
            if (!(type is SimpleTypeInformation<T>))
            {
                return false;
            }
            SimpleTypeInformation<T> simpleType = (SimpleTypeInformation<T>)type;
